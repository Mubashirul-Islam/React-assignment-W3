...
function TaskList() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="bg-orange-500 dark:bg-blue-500 mx-20 my-4 py-2 rounded-lg relative">
      ...
      <div className="flex sm:flex-col md:flex-row sm:gap-10 md:gap-20 justify-center items-center min-w-screen px-20 mb-20 text-center">
        <button
